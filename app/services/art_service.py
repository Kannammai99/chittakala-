...
CATEGORIES_SEED: List[Category] = [
    ...
    Category(
        ...
        art_form_id="madhubani",
        title="Madhubani Peacock & Fish Motifs",
        short_description="Symbolic fish of fertility and intricate double-outlined peacock feathers.",
    ...
    Category(
        ...
        art_form_id="madhubani",
        title="Sun & Tree of Life Geometry",
        short_description="Sacred Surya motifs and branching Tree of Life filled with fine hatching.",
...
EXERCISES_SEED: List[Exercise] = [
    ...
    Exercise(
        ...
        art_form_id="madhubani",
        category_id="madhubani-borders",
        title="Double-Line Wave & Floral Border",
        art_form="Madhubani",
        difficulty="beginner",
        short_description="Draw a traditional Mithila dual-line wave border filled with fine parallel hatching lines and lotus flower buds.",
        reference_image_path="/art/madhubani/borders/example-01.png",
        visible_elements=["dual parallel border lines", "fine hatching fills (Kachni)", "lotus bud curves"],
        drawing_guidance=[
            "Draw two parallel border lines along the perimeter of your paper.",
            "Draw a continuous waving stem line between the double borders.",
            "Fill the background with fine parallel hatching lines (Kachni style)."
        ],
        allowed_next_actions=["repeat", "next_example", "change_category", "finish"],
    ...
    Exercise(
        ...
        art_form_id="madhubani",
        category_id="madhubani-nature",
        title="Mithila Sacred Fish of Prosperity",
        art_form="Madhubani",
        difficulty="intermediate",
        short_description="Draw a pair of Madhubani fish with prominent double-line fins, large expressive eyes, and dense hatching.",
        reference_image_path="/art/madhubani/nature/example-01.png",
        visible_elements=["twin fish motifs", "double-line body contours", "hatching line fills and lotus flowers"],
        drawing_guidance=[
            "Draw the double-line outline of two fish curving toward each other.",
            "Draw large circular eyes and decorative double fins.",
            "Fill the fish scales with alternating hatching lines and tiny dot accents."
        ],
        allowed_next_actions=["repeat", "next_example", "change_category", "finish"],
        source_attribution="Mithila Madhubani art tradition of Bihar",
        review_status="reviewed",
    ...
    Exercise(
        ...
        art_form_id="madhubani",
        category_id="madhubani-sacred",
        title="Madhubani Radiant Sun Motif",
        art_form="Madhubani",
        difficulty="challenging",
        short_description="Draw a ceremonial Madhubani Sun (Surya) with double-line rays, lotus petals, and symmetrical facial features.",
        reference_image_path="/art/madhubani/sacred/example-01.png",
        visible_elements=["central circular Sun face", "radiating double-line rays", "alternating lotus petal rays"],
        drawing_guidance=[
            "Draw a central circular face with expressive eyes and nose contour.",
            "Construct concentric double-line rings around the Sun face.",
            "Add radiating triangular and lotus petal rays filled with fine cross-hatching."
        ],
        allowed_next_actions=["repeat", "finish"],
        source_attribution="Mithila Madhubani art tradition of Bihar",
        review_status="reviewed",
